...
export const en = {
  ...
  copyLinkFailedTitle: 'Could Not Copy Link',
  copyLinkFailed: 'Select the link text and try copying it again.',
  externalLinkFailedTitle: 'Could Not Open Link',
  externalLinkFailed: 'Copy the link address and open it in your browser manually.',
...
export const zh = {
  ...
  copyLinkFailedTitle: '无法复制链接',
  copyLinkFailed: '请选中链接文字，然后重试复制。',
  externalLinkFailedTitle: '无法打开链接',
  externalLinkFailed: '请复制链接地址，然后在浏览器中手动打开。',
