...
describe('desktop package target', () => {
  ...
  it('accepts explicit local test artifacts and rejects preparation-only use', () => {
    ...
    expect(parseDesktopPackageInvocation(['mac-arm64'], 'darwin', 'arm64').unsigned).toBe(false)
